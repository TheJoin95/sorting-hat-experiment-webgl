...
(function(window, undefined) {
  ...
  tracking.trackVideo_ = function(element, tracker, options) {
    ...
    var resizeCanvas_ = function() {
      width = (element.videoWidth > window.innerWidth || element.videoWidth > element.offsetWidth) ? element.offsetWidth : element.videoWidth;
      height = (element.videoHeight > window.innerHeight || element.videoHeight > element.offsetHeight) ? element.offsetHeight : element.videoHeight;
      canvas.width = width;
      canvas.height = height;
    };
    resizeCanvas_();
